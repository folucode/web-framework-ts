...
/** @class */
function () {
  function Collection(rootUrl, deserialze) {
    this.rootUrl = rootUrl;
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (response) {
      response.data.forEach(function (value) {
        _this.models.push(_this.deserialze(value));
      });
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts"}],"src/models/UserForm.ts":[function(require,module,exports) {
"use strict";
...
var UserForm_1 = require("./models/UserForm");
...
},{"./models/User":"src/models/User.ts","./models/UserForm":"src/models/UserForm.ts"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
